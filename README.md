# CS 1670: development environment

This repo contains a minimal dev environment setup for CS 1670. In
particular, it provides the scripts to check host system compatibility
with different methods of setting up the course development
environment and to create the course Docker container if needed.

## Getting started (for students)

Start by running the `check-host-system` script:

```bash
./check-host-system
```

This will tell you what kind of setup is appropriate for your system.

If you decide to use the container environment:
...
page](https://github.com/csci1670/container-dev/pkgs/container/cs1670-dev),
